...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["a Computer Science Student", "into Web Development", "into Data Structures and Algorithms"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 35,
		backDelay: 500,
...
// <!-- tilt js effect ends -->
 ...
 $("#contact-form").submit(function (event) {
    ...
    emailjs.init("9dAzNaQlUX8vptPKu");
    ...
    console.log(params)
    emailjs.send('service_fn2mgey', 'template_t3k7b5f', params).then(function (response) {
